...
const SavingsCalculator: React.FC = () => {
  ...
  // 🔥 Update fee when currency changes
  useEffect(() => {
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="text-right text-blue-400 font-bold mt-1">
                  {appointments}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative mt-2">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900 border border-slate-600 rounded-lg py-2 pl-8 pr-4"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-4 mt-2">
                  ...
                  <span className="text-red-400 font-bold w-12">
                    {commission}%
                  </span>
                </div>
              </div>
            ...
            <div className="flex flex-col justify-center gap-4">
              ...
              <div className="bg-slate-700/50 p-6 rounded-xl border border-slate-600">
                ...
                <h2 className="text-2xl font-bold text-red-400">
                  {symbol}
                  {Math.round(platformCost).toLocaleString()}
                </h2>
              </div>
